--preload code 
-- creation of tables and populations
...
INSERT INTO EVENT (EVENT_ID, EVENT_NAME, EVENT_RATE) 
VALUES (1001, 'Open Air Comedy Festival', 300.00);
...
VALUES (1, TO_DATE('2024-07-15', 'YYYY-MM-DD'), 1002, 'A_101');

INSERT INTO BOOKINGS (BOOKING_ID, BOOKING_DATE, EVENT_ID, ARTIST_ID) 
VALUES (2, TO_DATE('2024-07-15', 'YYYY-MM-DD'), 1002, 'A_102');

INSERT INTO BOOKINGS (BOOKING_ID, BOOKING_DATE, EVENT_ID, ARTIST_ID) 
VALUES (3, TO_DATE('2024-08-27', 'YYYY-MM-DD'), 1001, 'A_103');

INSERT INTO BOOKINGS (BOOKING_ID, BOOKING_DATE, EVENT_ID, ARTIST_ID) 
VALUES (4, TO_DATE('2024-08-30', 'YYYY-MM-DD'), 1003, 'A_101');

INSERT INTO BOOKINGS (BOOKING_ID, BOOKING_DATE, EVENT_ID, ARTIST_ID) 
VALUES (5, TO_DATE('2024-08-30', 'YYYY-MM-DD'), 1003, 'A_102');

--QUESTION 1 : SQL QUERY FOR BOOKING DETAILS
SELECT
    B.BOOKING_ID,
    E.EVENT_NAME,
    E.EVENT_RATE,
...
--QUESTION 2: SQL QUERY FOR ARTIST WITH LEAST PERFORMANCES
SELECT
    A.ARTIST_ID,
    A.ARTIST_NAME,
    A.ARTIST_EMAIL,
...
--QUESTION 3: SQL QUERY FOR ARTIST REVENUE
SELECT
    A.ARTIST_NAME,
...
--QUESTION 4: PL/SQL QUERY FOR ARTIST AND BOOKING DATE
SET SERVEROUTPUT ON;
...
--QUESTION 5: PL/SQL QUERY FOR EVENT DISCOUNTS
SET SERVEROUTPUT ON;
...
--QUESTION 6 : CREATE EVENT_SCHEDULES VIEW
...
--QUESTION 7 : STORED PROCEDURE FOR BOOKING DETAILS
...
SET SERVEROUTPUT ON;
BEGIN
    Get_Bookings_By_Artist('Lol Man');
END;

--QUESTION 8: CREATE A RELEVANT FUNCTION
--STEP 1
...
DECLARE
    v_revenue NUMBER;
BEGIN
    v_revenue := Get_Artist_Revenue('Max Trillion');

    IF v_revenue = -1 THEN
        DBMS_OUTPUT.PUT_LINE('Error occurred while calculating revenue.');
    ELSIF v_revenue = 0 THEN
        DBMS_OUTPUT.PUT_LINE('Artist has no bookings.');
    ELSE
        DBMS_OUTPUT.PUT_LINE('Total revenue for Max Trillion: R' || v_revenue);
    END IF;
END;

--QUESTION 11: CREATE A TRIGGER TO PREVENT WEEKEND BOOKINGS


SELECT USER FROM DUAL;

CREATE USER C##oneuser IDENTIFIED BY strongpassword123;
GRANT CONNECT, RESOURCE TO C##oneuser;
